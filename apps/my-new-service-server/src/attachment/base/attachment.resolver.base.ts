...
import { JobRequirement } from "../../jobRequirement/base/JobRequirement";
...
export class AttachmentResolverBase {
  ...
  async createAttachment(
    ...
    return await this.service.createAttachment({
      ...
      data: {
        ...
        jobRequirement: args.data.jobRequirement
          ? {
              connect: args.data.jobRequirement,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => JobRequirement, {
    nullable: true,
    name: "jobRequirement",
  })
  @nestAccessControl.UseRoles({
  ...
  async getJobRequirement(
    ...
    const result = await this.service.getJobRequirement(parent.id);

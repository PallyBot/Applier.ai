...
@InputType()
class AttachmentCreateNestedManyWithoutJobRequirementsInput {
...
export { AttachmentCreateNestedManyWithoutJobRequirementsInput as AttachmentCreateNestedManyWithoutJobRequirementsInput };

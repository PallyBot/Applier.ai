...
@InputType()
class AttachmentUpdateManyWithoutJobRequirementsInput {
...
export { AttachmentUpdateManyWithoutJobRequirementsInput as AttachmentUpdateManyWithoutJobRequirementsInput };
